...
const COLOR_THEMES = {
  green: {
    pageBg: "linear-gradient(135deg, #f0fdf4 0%, #ffffff 42%, #ecfdf5 100%)",
    softBorder: "#bbf7d0",
    focus: "#16a34a",
    focusRgb: "22,163,74",
    dateBg: "#dcfce7",
    ...
    dateText: "#14532d",
    dateTextActive: "#064e3b",
    slotBg: "#f0fdf4",
    slotBgActive: "#16a34a",
    slotBorder: "#86efac",
    slotBorderActive: "#15803d",
    slotText: "#166534",
    slotShadowActive: "rgba(22,163,74,0.28)",
    strong: "#15803d",
    strongHover: "#16a34a",
  },
  blue: {
    pageBg: "linear-gradient(135deg, #eff6ff 0%, #ffffff 42%, #dbeafe 100%)",
    softBorder: "#bfdbfe",
    focus: "#2563eb",
    focusRgb: "37,99,235",
    dateBg: "#dbeafe",
    ...
    dateText: "#1e3a8a",
    dateTextActive: "#172554",
    slotBg: "#eff6ff",
    slotBgActive: "#2563eb",
    slotBorder: "#93c5fd",
    slotBorderActive: "#1d4ed8",
    slotText: "#1e40af",
  ...
  red: {
    pageBg: "linear-gradient(135deg, #fef2f2 0%, #ffffff 42%, #fee2e2 100%)",
    softBorder: "#fecaca",
    focus: "#dc2626",
    focusRgb: "220,38,38",
    dateBg: "#fee2e2",
    ...
    dateText: "#7f1d1d",
    dateTextActive: "#450a0a",
    slotBg: "#fef2f2",
    slotBgActive: "#dc2626",
    slotBorder: "#fca5a5",
    slotBorderActive: "#b91c1c",
    slotText: "#991b1b",
...
<section style={{ background: "rgba(255,239,239,0.96)", border: "1px solid #bfdbfe", borderRadius: 30, padding: 24, boxShadow: "0 16px 45px rgba(15,23,42,0.08)" }}>
